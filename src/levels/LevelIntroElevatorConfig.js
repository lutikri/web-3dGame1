...
import { LEVEL_INTRO_ELEVATOR_OVERRIDES } from "../generated/LevelIntroElevatorOverrides.js?v=soma-body-weight";
import { LEVEL_CONFIG_SCHEMA_VERSION } from "./LevelConfigSchema.js?v=soma-body-weight";
