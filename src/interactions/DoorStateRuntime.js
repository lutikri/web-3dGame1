...
import { applyAxisRotation } from "../scene/TransformUtils.js?v=body-motion-debug";
import { applyDoorLatchHandleRotation } from "../prefabs/behaviors/DoorLatchBehavior.js?v=body-motion-debug";
