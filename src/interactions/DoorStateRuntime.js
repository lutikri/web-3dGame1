...
import { applyAxisRotation } from "../scene/TransformUtils.js?v=camera-return";
import { applyDoorLatchHandleRotation } from "../prefabs/behaviors/DoorLatchBehavior.js?v=camera-return";
