...
import { applyAxisRotation } from "../scene/TransformUtils.js?v=stable-first-boot-layout";
import { applyDoorLatchHandleRotation } from "../prefabs/behaviors/DoorLatchBehavior.js?v=stable-first-boot-layout";
