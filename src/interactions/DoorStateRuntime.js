...
import { applyAxisRotation } from "../scene/TransformUtils.js?v=shift-terminal-content";
import { applyDoorLatchHandleRotation } from "../prefabs/behaviors/DoorLatchBehavior.js?v=shift-terminal-content";
