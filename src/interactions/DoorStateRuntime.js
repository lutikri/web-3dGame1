...
import { applyAxisRotation } from "../scene/TransformUtils.js?v=terminal-icons";
import { applyDoorLatchHandleRotation } from "../prefabs/behaviors/DoorLatchBehavior.js?v=terminal-icons";
