...
import { applyAxisRotation } from "../scene/TransformUtils.js?v=prototype-flow-1";
import { applyDoorLatchHandleRotation } from "../prefabs/behaviors/DoorLatchBehavior.js?v=prototype-flow-1";
