const STRINGS = {
  en: {
    ...
    "subtitles.tutorial-where": "...where am I?",
    "subtitles.tutorial-again": "I've done this before.",
    "subtitles.tutorial-ignite": "The panel says \"Ignite\".",
    "subtitles.tutorial-start-core": "Right. Now I need to wake this thing up.",
  ...
  ru: {
    ...
    "subtitles.tutorial-where": "...где я?",
    "subtitles.tutorial-again": "Я уже делал это.",
    "subtitles.tutorial-ignite": "На панели написано «Ignite».",
    "subtitles.tutorial-start-core": "Так. Теперь надо как-то его запустить.",
