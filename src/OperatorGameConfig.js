...
//window.operatorGameDebug.getPerformance()
  ...
  feedback: {
    startup: {
      ...
      tubeOnPattern: [
        { time: 0, factor: 0 },
        { time: 0.14, factor: 0.04 },
        { time: 0.3, factor: 0.16 },
        { time: 0.4, factor: 0.03 },
        { time: 0.52, factor: 0.46 },
        { time: 0.61, factor: 0.05 },
        { time: 0.74, factor: 0.76 },
        { time: 0.84, factor: 0.12 },
        { time: 1.02, factor: 0.96 },
        { time: 1.13, factor: 0.34 },
        { time: 1.3, factor: 1.03 },
        { time: 1.5, factor: 1 },
      ],
    },
    roomLightSwitch: {
