  ...
  interior: {
    ...
    specialMaterials: {
      ...
      bricks1: {
        ...
        maskOverlay: {
          debugView: false,
          red: { color: "#804800", opacity: 0.7, intensity: 1, threshold: 0, softness: 1, blend: "multiply" },
          green: { color: "#54582c", opacity: 0.7, intensity: 1.0, threshold: 0, softness: 1, blend: "multiply" },
          blue: { color: "#313335", opacity: 0.8, intensity: 0.7, threshold: 0, softness: 1, blend: "multiply" },
        },
      },
      Interior1: {
        meshNames: [
