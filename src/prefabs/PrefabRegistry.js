...
const PREFAB_DEFINITIONS = {
  ...
  PanelStatusViewport1: {
    assetPath: "assets/mesh/prefabs/SM_PanelStatusViewport1.glb",
    materialKey: "panelStatusView1",
    ...
    statusViewport: {
      ...
      indicators: {
        AlarmSilence: { tint: 0xffffff, intensity: 2.2 },
        Generation: { tint: 0xffffff, intensity: 2.1 },
        Cireculation: { tint: 0xffffff, intensity: 1.8 },
        Turbine: { tint: 0xffffff, intensity: 1.8 },
        Pumps: { tint: 0xffffff, intensity: 1.8 },
        Fuel: { tint: 0xffffff, intensity: 1.8 },
        Output: { tint: 0xffffff, intensity: 2.1 },
        Demand: { tint: 0xffffff, intensity: 1.8 },
        Battery: { tint: 0xffffff, intensity: 1.8 },
        Efficiency: { tint: 0xffffff, intensity: 2.2 },
        Stall: { tint: 0xffffff, intensity: 2.2 },
