...
import { createPrefabInstance, getPrefabDefinition } from "./PrefabRegistry.js?v=shift-terminal-content";
import { registerPrefabPlacement } from "./PrefabPlacementMetadata.js?v=shift-terminal-content";
