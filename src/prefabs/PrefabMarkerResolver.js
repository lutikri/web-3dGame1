...
import { createPrefabInstance, getPrefabDefinition } from "./PrefabRegistry.js?v=stable-first-boot-layout";
import { registerPrefabPlacement } from "./PrefabPlacementMetadata.js?v=stable-first-boot-layout";
