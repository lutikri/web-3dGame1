...
import { createPrefabInstance, getPrefabDefinition } from "./PrefabRegistry.js?v=development-notice-v1";
import { registerPrefabPlacement } from "./PrefabPlacementMetadata.js?v=development-notice-v1";
