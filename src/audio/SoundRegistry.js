export const SOUND_REGISTRY = {
  ...
  Menu_Musical1: { path: "assets/sounds/ambience/Menu_Musical1.ogg", loop: true, volume: 0.476, fadeSeconds: 1.8 },
  Menu_Musical2: { path: "assets/sounds/ambience/Menu_Musical2.ogg", loop: true, volume: 0.476, fadeSeconds: 1.8 },
  Menu_Musical3_rare: { path: "assets/sounds/ambience/Menu_Musical3_rare.ogg", loop: true, volume: 0.476, fadeSeconds: 1.8 },
  Menu_Musical4: { path: "assets/sounds/ambience/Menu_Musical4.ogg", loop: true, volume: 0.476, fadeSeconds: 1.8 },
  Menu_Musical5: { path: "assets/sounds/ambience/Menu_Musical5.ogg", loop: true, volume: 0.476, fadeSeconds: 1.8 },
  Menu_Musical6: { path: "assets/sounds/ambience/Menu_Musical6.ogg", loop: true, volume: 0.476, fadeSeconds: 1.8 },
  ...
  TCorporateIntro1: { path: "assets/sounds/ui/TCorporateIntro1.ogg", volume: 0.82 },
  ...
  Core1_Panel1_AlarmCoreStall: { path: "assets/sounds/machinery/Core1_Panel1_AlarmCoreStall.ogg", loop: true, volume: 0.5 },
  Core1_Panel1_AlarmHighCoreStress1: { path: "assets/sounds/machinery/Core1_Panel1_AlarmHighCoreStress1.ogg", loop: true, volume: 0.57 },
  Core1_Panel1_AlarmHighTemp1: { path: "assets/sounds/machinery/Core1_Panel1_AlarmHighTemp1.ogg", volume: 0.68 },
